...
print("Вывод: стек разворачивается в обратном порядке (LIFO). Много повторных вызовов - алгоритм медленный.")

print("\nЗадание 2. Максимум (разделяй и властвуй):")
numbers = [3, 9, 1, 7, 4]
print(f"Список {numbers}, max = {find_max(numbers)}")
print("Вывод: делим список пополам, ищем max слева и справа, берем большее.")

print("\nЗадание 3. QuickSort:")
unsorted = [3, 6, 8, 10, 1, 2, 1]
print(f"Было:  {unsorted}")
print(f"Стало: {quicksort(unsorted)}")
print("Вывод: берем опорный элемент, делим на меньшие и большие, сортируем части рекурсивно.")
...
print("Вывод: на маленьком списке (10) разница небольшая. На 1000 QuickSort намного быстрее вставок.")
